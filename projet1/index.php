    ...
    <body onload="switchAlcohols()">
            ...
            <nav id="navigation" class="onepage navbar navbar-expand-lg fixed-top scrolling-navbar border-bottom shadow-sm p-3 mb-5 rounded navbar-dark">		
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link events" href="#onepageEvents">Evenements</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link galerie" href="#onepageGalerie">Galerie</a>
                        </li>
                        <li class="nav-item">
        ...
        <main>
            <div id="home">
                ...
                <h1>Bienvenue au GIGG'S Irish Pub</h1>
                
                <p>Situé en face de la cathédrale de Nantes, ce pub propose de nombreuses bières mais également des burgers délicieux et des plats traditionnels qui valent le détour !</p>
                <p>Fan de sport en tout genre ? Le Gigg's diffuse des matchs de différents sports sur ces nombreux écrans !</p>
            ...
            <div id="menus">
                ...
                <div class="drink">
                    ...
                    <a onclick="openInNewTab('menus/<?= $menusDrinks['pdf'] ?>.pdf');" href="menus/<?= $menusDrinks['pdf'] ?>.pdf" class="cards">Carte Complète des boissons</a> <br>
                    <p>HAPPY HOUR - Du lundi au Vendredi de 17H à 20H</p>
                        ...
                        <div class="burgers">
                            <ul>
                                ...
                                <?php foreach($burgers as $burger): ?>
                                    ...
                                    <li><em><?= $burger['description_fr'] ?></em></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <div class="brunch">
                            <ul>
                                ...
                                <?php foreach($salads as $salad): ?>
                                    ...
                                    <li><em><?= $salad['description_fr'] ?></em></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                        <div class="specials">
                            <ul>
                                ...
                                <?php foreach($dishes as $dish): ?>
                                    ...
                                    <li><em><?= $dish['description_fr'] ?></em></li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
                    </div>
                    <a onclick="openInNewTab('menus/<?= $menusFoods['pdf'] ?>.pdf');" href="menus/<?= $menusFoods['pdf'] ?>.pdf" class="cards">Carte Complète des menus</a> <br>
                    <small>V : Convient aux Végétariens</small>
                </div>
            ...
            <div id="onepageEvents">
                <h2>Les Evenements du Gigg's !</h2>
                <div id="events">
            ...
            <div id="onepageGalerie">
                <h2>La galerie photo du Gigg's !</h2>
                <div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <div class="col-md-2">
                                    <button type="button" class="btn btn-dark btn-lg" id="show-previous-image">Précédent</button>
                                </div>
                                ...
                                <div class="col-md-2">
                                    <button type="button" id="show-next-image" class="btn btn-dark btn-lg">Suivant</button>
                                </div>
                            </div>
                        </div>
                    </div>
